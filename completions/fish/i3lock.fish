# i3lock
# Autogenerated from man page manpages/i3lock.1
...
complete -c i3lock -l time-align -l date-align -l layout-align -l verif-align -l wrong-align -l modif-align --description 'Sets the text alignment of the time, date, keylayout, verification text, wron…'
